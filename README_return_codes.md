...
> **Legacy `/api/v2` error catalog.** Current `/v1` endpoints use their
> OpenAI/Anthropic-compatible error shapes and FastAPI validation responses; do
> not build a new Grid client against these Horde RC values.
