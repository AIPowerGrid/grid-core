...
# feed routing or economics: they are an offline comparison between the real
# route and a hypothetical validator-informed route.  Candidate/evidence JSON
# contains bounded internal identifiers required for deterministic replay, but
# never customer prompts, outputs, accounts, wallets, nonces, or signatures.
validator_shadow_runs = sa.Table(
    "grid_validator_shadow_runs",
    metadata,
    sa.Column("id", sa.String(96), primary_key=True),
    sa.Column("status", sa.String(16), nullable=False, default="draft", index=True),
    sa.Column("policy_version", sa.String(96), nullable=False),
    sa.Column("policy_config", PortableJSON, nullable=False),
    ...
    sa.Column("start_gate", PortableJSON, nullable=False),
...
validator_shadow_observations = sa.Table(
    ...
    sa.Column("decision_class", sa.String(32), nullable=False, index=True),
    sa.Column("reason_code", sa.String(64), nullable=False, index=True),
    ...
    sa.Column("evidence_commitments", PortableJSON, nullable=False),
    sa.Column("eligible_operator_count", sa.Integer, nullable=False),
    sa.Column("mutation_attempted", sa.Boolean, nullable=False, default=False),
    sa.Column("created", sa.DateTime(timezone=True), nullable=False, default=utcnow),
    sa.UniqueConstraint(
        "run_id",
        "route_ref",
...
validator_shadow_outcomes = sa.Table(
    ...
    sa.Column("payload_hash", sa.String(64), nullable=False),
    sa.Column("actual_worker_id", sa.String(64), nullable=True),
    sa.Column("terminal_status", sa.String(16), nullable=False, index=True),
    sa.Column("duration_ms", sa.Integer, nullable=True),
    sa.Column("finished_at", sa.DateTime(timezone=True), nullable=False, index=True),
    sa.Column("created", sa.DateTime(timezone=True), nullable=False, default=utcnow),
    sa.CheckConstraint(
...
validator_shadow_capacity_samples = sa.Table(
    ...
    sa.Column("quorum_available", sa.Boolean, nullable=False, index=True),
    sa.Column("created", sa.DateTime(timezone=True), nullable=False, default=utcnow),
    sa.UniqueConstraint(
        "run_id",
        "sampled_at",
...
validator_shadow_errors = sa.Table(
...
validator_audit_budget_counters = sa.Table(
    ...
    sa.Column("reserved_units", sa.BigInteger, nullable=False, default=0),
    sa.Column("spent_units", sa.BigInteger, nullable=False, default=0),
    sa.Column("created", sa.DateTime(timezone=True), nullable=False, default=utcnow),
    sa.Column("updated", sa.DateTime(timezone=True), nullable=False, default=utcnow),
    sa.CheckConstraint(
...
validator_audit_jobs = sa.Table(
    ...
    sa.Column("budget_bucket_start", sa.DateTime(timezone=True), nullable=False, index=True),
    sa.Column("reserved_units", sa.BigInteger, nullable=False),
    sa.Column("actual_units", sa.BigInteger, nullable=True),
    sa.Column("request_hash", sa.String(64), nullable=False),
    sa.Column("result_hash", sa.String(64), nullable=True),
    sa.Column("status", sa.String(24), nullable=False, default="held", index=True),
